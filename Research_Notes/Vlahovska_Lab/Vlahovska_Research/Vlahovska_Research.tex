...
\end{equation}
This is done by neglecting higher order terms in the expansion and that if the completely open, then the concentration gradient should collapse and so thus 
\begin{equation}
